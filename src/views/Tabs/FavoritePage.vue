  ...
  <ion-page>
    ...
    <ion-content :fullscreen="true">
      ...
      <div v-if="favorites.length > 0">
        <ion-card v-for="favorite in favorites" :key="favorite.favorable.id" @click="showCouponDetails(favorite.favorable)">
          <ion-card-header>
      ...
      <ion-modal :is-open="isOpen" ref="couponModal" :initial-breakpoint="0.75" :breakpoints="[0, 0.25, 0.5, 0.75, 1]" handle-behavior="cycle" @didDismiss="hideModal">
...
<script setup>
import { IonModal, IonButton, IonCard, IonCardHeader, IonCardContent, IonCardTitle, IonPage, IonHeader, IonToolbar, IonTitle, IonContent } from '@ionic/vue';
