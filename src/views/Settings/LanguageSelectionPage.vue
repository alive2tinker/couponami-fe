<template>
    <ion-page>
        ...
        <ion-content :fullscreen="true">
            ...
            <ion-list>
                <ion-item>
                    <ion-checkbox slot="start" :checked="this.$i18n.locale === 'ar'" @click="changeLocale('ar')"></ion-checkbox>
                    <ion-label>العربية</ion-label>
                </ion-item>
                <ion-item>
                    <ion-checkbox slot="start" :checked="this.$i18n.locale === 'en'" @click="changeLocale('en')"></ion-checkbox>
    ...
    export default defineComponent({
        ...
        methods: {
            changeLocale(nuLocale){
                this.$root.$i18n.locale = nuLocale;
